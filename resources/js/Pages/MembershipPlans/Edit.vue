...
const form = useForm({
    ...
    duration_days: props.plan.duration_days?.toString() ?? '',
    status: props.plan.status ?? 'active',
})

const submit = () => {
    form.put(
        route('membership-plans.update', props.plan.id)
    )
}
</script>
            ...
            <form class="space-y-6 rounded-xl border bg-white p-6 shadow-sm" @submit.prevent="submit">
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <Input id="duration_days" v-model="form.duration_days" type="number" min="1" />
